...
export default function EditTask() {
    ...
    useEffect(() => {
        ...
        if (taskToEdit) {
            ...
            setTag(taskToEdit.tags[0]);
        } else {
            navigate('/tasks'); // If not found, redirect to list
        }
    }, [id, getTask, navigate]);
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 lg:py-12">
            ...
            <div className="flex items-center mb-10 sm:mb-16">
                ...
                <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">Edit Task</h1>
            </div>
            ...
            <div className="mt-12 text-center pb-8">
                <button
                    ...
                    className="text-purple-600 hover:text-purple-800 font-medium pb-1 transition-all underline-offset-4 decoration-2 underline"
                >
                    Back To Top
                </button>
            </div>
